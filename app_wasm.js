...
function findWasmBinary() {
    return locateFile('app_wasm.wasm');
}
...
var _set_panel_count = Module['_set_panel_count'] = makeInvalidEarlyAccess('_set_panel_count');
var _set_panel_height = Module['_set_panel_height'] = makeInvalidEarlyAccess('_set_panel_height');
var _set_panel_space = Module['_set_panel_space'] = makeInvalidEarlyAccess('_set_panel_space');
var _set_angle_base = Module['_set_angle_base'] = makeInvalidEarlyAccess('_set_angle_base');
var _set_angle_cabin = Module['_set_angle_cabin'] = makeInvalidEarlyAccess('_set_angle_cabin');
var _set_angle_boom = Module['_set_angle_boom'] = makeInvalidEarlyAccess('_set_angle_boom');
var _set_angle_stick = Module['_set_angle_stick'] = makeInvalidEarlyAccess('_set_angle_stick');
var _set_angle_bucket = Module['_set_angle_bucket'] = makeInvalidEarlyAccess('_set_angle_bucket');
var _set_angle_tilt = Module['_set_angle_tilt'] = makeInvalidEarlyAccess('_set_angle_tilt');
var _set_angle_rotate = Module['_set_angle_rotate'] = makeInvalidEarlyAccess('_set_angle_rotate');
var _set_angle_lift = Module['_set_angle_lift'] = makeInvalidEarlyAccess('_set_angle_lift');
...
var _set_color_pile = Module['_set_color_pile'] = makeInvalidEarlyAccess('_set_color_pile');
...
function assignWasmExports(wasmExports) {
  ...
  Module['_set_panel_count'] = _set_panel_count = createExportWrapper('set_panel_count', 1);
  Module['_set_panel_height'] = _set_panel_height = createExportWrapper('set_panel_height', 1);
  Module['_set_panel_space'] = _set_panel_space = createExportWrapper('set_panel_space', 1);
  Module['_set_angle_base'] = _set_angle_base = createExportWrapper('set_angle_base', 1);
  Module['_set_angle_cabin'] = _set_angle_cabin = createExportWrapper('set_angle_cabin', 1);
  Module['_set_angle_boom'] = _set_angle_boom = createExportWrapper('set_angle_boom', 1);
  Module['_set_angle_stick'] = _set_angle_stick = createExportWrapper('set_angle_stick', 1);
  Module['_set_angle_bucket'] = _set_angle_bucket = createExportWrapper('set_angle_bucket', 1);
  Module['_set_angle_tilt'] = _set_angle_tilt = createExportWrapper('set_angle_tilt', 1);
  Module['_set_angle_rotate'] = _set_angle_rotate = createExportWrapper('set_angle_rotate', 1);
  Module['_set_angle_lift'] = _set_angle_lift = createExportWrapper('set_angle_lift', 1);
  ...
  Module['_set_color_pile'] = _set_color_pile = createExportWrapper('set_color_pile', 1);
...
var wasmImports = {
  ...
  /** @export */
  wsCreateWebSocket: _wsCreateWebSocket,
  /** @export */
  wsDeleteWebSocket: _wsDeleteWebSocket,
  /** @export */
  wsSendMessage: _wsSendMessage,
  /** @export */
  wsSetErrorCallback: _wsSetErrorCallback,
  /** @export */
  wsSetMessageCallback: _wsSetMessageCallback,
  /** @export */
  wsSetOpenCallback: _wsSetOpenCallback,
  /** @export */
  wsSetUserPointer: _wsSetUserPointer
};
var wasmExports;
createWasm();
